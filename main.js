...
const order = document.querySelector(".orer");
...
btn1.addEventListener("click", () => {
  const eachCountry = document.createElement("p");
  content.appendChild(eachCountry);

  for (let i = 0; i <= countries.length; i++) {
    if (countries[i].startsWith(input.value.toLocaleUpperCase())) {
      eachCountry.textContent = countries[i];
    }
  }
});
